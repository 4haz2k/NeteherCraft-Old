...
<head>
    ...
    <title>Склад » NetherCraft Project</title>
</head>
<body>
<header>
...
<div id="nether_menu"><div class="nether-bottom-menu">
        <div class="nether-menu-div">
            <ul class="nether-menu-ul">
                ...
                <li style="width: 185px!important;"><a href="/cart"><button class="nether-orange-pitted-button nether-menu-button"><span>Корзина</span></button></a></li>
            </ul>
        </div>
    </div>
</div>
